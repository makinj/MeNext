        ...
        function(data,status){
          if (status=="success"){
            ...
            for (var i=0;i<videos.length;i++){
              ...
              link.innerHTML=(i+1).toString()+"<a href='https://www.youtube.com/watch?v="+videos[i].id.videoId+"' target='_blank'>"+"<img src='"+videos[i].snippet.thumbnails.default.url+"'/>"+videos[i].snippet.title+"</a>";
